...
{
	out.println("<html><h2><center>"+request.getAttribute("withdraw")+"</center></h2></html>");
}
		...
		<div class="container-fluid mb-3">
			<div>
				<form action="withdraw1.jsp"  name="F1" method="post">
					<dl>
						...
						<dd>
							<input type="number" name="wamount" id="wamount" placeholder="Enter Withdraw Amount">
						</dd>
