...
<script>
	function check() {
		if (document.getElementById('pword').value != document
				.getElementById('repword').value) {
			alert('Password does not match')
			document.F1.repword.value = ""
			document.F1.repword.focus()
			return false;
		}
	}
</script>
...
UPI facility|</li>
    ...
    <div class="row border border-black">
		...
		<div class="container-fluid mb-3">
			<div>
				<form action="login" onsubmit="return check()" name="F1" method="post">
					<dl>
						<dt>UserName</dt>
						<dd>
						...
						<dd>
							<input type="password" name="repword" id="repword"
								placeholder="Re-Enter Password" required minlength="4">
						</dd>
						<dt>Amount</dt>
						<dd>
							<input type="number" name="amount" id="amount" min="500"
								placeholder="Enter Deposit Amount (>500)" required>
						</dd>
						<dt>Address</dt>
						<dd>
						...
						<dt>Phone Number</dt>
						<dd> <input type="number" placeholder="Enter Mobile Number" min="999999999" max="9999999999" name="phn"> </dd>
